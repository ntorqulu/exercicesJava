...
public class GuiJoc implements KeyListener {
    ...
    private void actualitzarJoc() {
        ...
        else if(heroina.haTrobatLesClaus() == true || heroina.haTrobatOr() == true){
            logica.setEstat(LogicaJoc.EstatJoc.GAMEOVER);
        }
    ...
    private void mostrarGameOver(BufferStrategy strategy) {
        ...
        if (heroina.haTrobatBrayan() && (heroina.haTrobatEscut())) {
            ...
            if(heroina.haTrobatLesClaus() || heroina.haTrobatOr()) {
               g2.drawString("HAS POGUT TROBAR LES CLAUS A TEMS!!!", 160, 130);                 
            }          
        }
