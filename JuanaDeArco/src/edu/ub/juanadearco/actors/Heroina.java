...
public class Heroina extends AbstractActor {   
    ...
    private ArrayList<String> clauArray;
    private boolean teOr;
    private boolean escutTrobat;
    private boolean brayanTrobat;
    ...
    // s'implementa a tots els actors excepte a la classe heroïna
    ...
    public void addClau(Clau clau){
        if((!clauArray.contains(clau.nom)) && clau.esClauOr == false){
            clauArray.add(clau.nom);
        }
        
    }
    public ArrayList<String> getClaus(){
        return clauArray;
    }
    
    
    public void setOr(Clau clau){
        if (clau.esClauOr == true){
            this.teOr = true;
        }   
    }
        public boolean haTrobatLesClaus(){
        return clauArray.size()== 4;
    }
    public boolean haTrobatOr(){
         return teOr == true;
    }
